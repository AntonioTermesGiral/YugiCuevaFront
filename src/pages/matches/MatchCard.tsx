        ...
        <Grid item key={match.id} xs={12} >
            <Card sx={{ py: 1, px: 2, m: 2, textAlign: "center" }}>
                ...
                <Grid container justifyContent="space-around" alignItems="center">
                    ...
                    <Grid item display="flex" my={1} xs={12} md="auto" justifyContent="center" onClick={() => navigate("/deck/?id=" + match.winners[0].playerDeckId)}>
                    ...
                    <Grid item display="flex" my={1} xs={12} md="auto" justifyContent="center" onClick={() => navigate("/deck/?id=" + match.losers[0].playerDeckId)}>
                        <Grid display="flex" flexDirection="column" justifyContent="center">
                            <Typography variant="h6">
